    ...
    def test_temperature_sensor_properties(self):
        ...
        temp_sensor = Sensor(
            ...
            properties={
                ...
                "hwmon_path": "/sys/class/hwmon/hwmon0/temp1_input",  # hwmon
    ...
    def test_fan_sensor_properties(self):
        ...
        fan_sensor = Sensor(
            ...
            properties={
                ...
                "hwmon_path": "/sys/class/hwmon/hwmon1/fan1_input",  # hwmon
            },
        )
    ...
    def test_pwm_actuator_properties(self):
        ...
        pwm_actuator = Actuator(
            ...
            properties={
                ...
                "enable_path": "/sys/class/hwmon/hwmon0/pwm1_enable",  # Enable
            },
        )
    ...
    def test_thermal_limit_actuator_properties(self):
        ...
        limit_actuator = Actuator(
            ...
            properties={
                ...
                "hwmon_path": "/sys/class/hwmon/hwmon0/temp1_max",  # Limit
            },
        )
