...
class TestRunnerSystemIntegration:
    ...
    def test_fast_runner_with_system(self):
        """Test FastRunner executing System with multiple Pipelines at different intervals."""
        ...
        # Calculate expected execution counts with tolerance for timing initialization
    ...
    def test_fast_runner_with_pipeline(self):
        ...
        pipeline = MockTimedPipeline(name="test_pipeline", interval_ns=50_000_000)  # 50ms
...
class TestHierarchicalComposition:
    ...
    def test_system_containing_pipelines(self):
        ...
        # Calculate exact execution counts: initial execution at t=0 plus interval-based executions
    ...
    def test_system_containing_systems(self):
        ...
        inner_system = MockTimedSystem(name="inner_system", interval_ns=60_000_000)
        ...
        # Calculate exact execution counts: executions at 0ms, 60ms, 120ms = 3 executions
        # But inner_system delegates to children (30ms interval), so executes at
...
class TestAdvancedScenarios:
    ...
    def test_dynamic_modification_during_execution(self):
        ...
        assert len(proc1.execution_timestamps) == 4  # 2 from first + 2 from second
    ...
    def test_timing_edge_cases(self):
        ...
        # slow_proc: execution at 0ms only (next would be at 500ms) = 1 execution
